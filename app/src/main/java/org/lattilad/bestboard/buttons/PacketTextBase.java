 ...
 */
public abstract class PacketTextBase extends Packet
    {
    protected PacketTextBase(SoftBoardData softBoardData)
        {
        super(softBoardData);
        }

    protected PacketTextBase(SoftBoardData softBoardData, String titleText)
        {
