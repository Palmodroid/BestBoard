...
public class FileChooserActivity extends FragmentActivity
    ...
    private void populateList(File dir, File previousDir) 
		...
		if (filesInDir == null)
			{
			FileChooserDialog.showNewDialog(this, FileChooserDialog.Type.SD_CARD_ERROR);
			return;
			}
    	...
    	FileEntryAdapter adapter = new FileEntryAdapter(FileChooserActivity.this, dirEntries);
	...
	public boolean onOptionsItemSelected(MenuItem item) 	
		...
		switch (item.getItemId())
			...
			case R.id.menu_new_file:
				{
				FileChooserDialog.showNewDialog(this, FileChooserDialog.Type.CREATE_FILE, filter.getText().toString());
				return true; 	
				}
			case R.id.menu_new_directory:
				{
				FileChooserDialog.showNewDialog(this, FileChooserDialog.Type.CREATE_DIRECTORY, filter.getText().toString());
				return true; 	
				}
			default: 	
	...
	public void onDialogPositiveResult( FileChooserDialog.Type type, String text)
		{
		switch (type)
			{
			case SD_CARD_ERROR:
			...
			case CREATE_DIRECTORY:
				...
				if ( newDir.mkdirs() ) // akár alkönyvtárral legyártja
					...
					FileChooserDialog.showNewDialog(this, FileChooserDialog.Type.CREATE_DIRECTORY, text);
					}
				break;
				}
			case CREATE_FILE:
